...
while True:
    ...
    for x,y in snake.snake_list:
        ...
        food_circle=pygame.draw.circle(screen,food.red_color,(food.x,food.y),food.size)
        if snake_box.colliderect(food_circle):
            food=Food(8)
    ...
    score=int((snake.snake_length-1)/5)
    screen_txt1=font.render(f"Score - {score}",True,(255,255,255))
    screen_txt2=font.render(f"by Madhesh",True,(255,255,255))
    screen.blit(screen_txt1,(10,10))
    screen.blit(screen_txt2,(400,10))
